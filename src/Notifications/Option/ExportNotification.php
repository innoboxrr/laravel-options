...
class ExportNotification extends Notification
{
    ...
    public function via($notifiable)
    {
        ...
        return config('innoboxrrlaraveloptions.notification_via', ['mail', 'database']);
    ...
    private function createExport()
    {
        ...
        Excel::store(new OptionsExports($this->data), $this->path, config('innoboxrrlaraveloptions.export_disk', 's3'));
