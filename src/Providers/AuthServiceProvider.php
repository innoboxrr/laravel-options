...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function mapPolicies()
    {
        ...
        $cacheKey = 'options_auth_policies';
    ...
    protected function customDiscoverPolicies()
    {
        ...
        foreach (glob(__DIR__ . '/../Policies/*.php') as $file) {
            $policy = 'Innoboxrr\LaravelOptions\Policies\\' . substr(basename($file), 0, -4);
            $model = 'Innoboxrr\LaravelOptions\Models\\' . str_replace('Policy', '', $policy);
